...
async def private_info(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'schedule':
        text = "📅 Расписание находится на вкладке 📅расписание. Обновляется каждую неделю! Бегом записываться🏃🏃🏃!!!\n\nЕсли после голосования ваши планы изменились и вы не сможете придти на тренировку,пожалуйста, отмените свой голос в опросе ❌(или переголосуйте🔄).\n\n Это поможет тренеру и нам точнее понимать, сколько человек будет.Спасибо за понимание! 🙌\n\n⚠️ Важно: не сможете придти — отмените свой голос в опросе ❌"
    elif query.data == 'what_to_take':
        text = "🎒 Что взять на тренировку:\n✅ полотенце\n✅ удобная обувь\n✅ удобная одежда\n✅ вода / бутылка для воды\n✅ хорошее настроение"
    elif query.data == 'location':
        text = "📍 Адрес: проспект Дзержинского, 19 (вход с ул.Щорса, 2 эт., над Белинвестбанком)"
    elif query.data == 'news':
        text = "📢 Новости:\n Сейчас проходит Challenge 'Фокус на лето' (ФНЛ).\n\n Подробнее:https://t.me/Focus_On_Summer \n\n16–17 мая  поход по верховому болоту Ельня \nYELNIA SWAMP by FOCUS — это не просто хайкинг, а полный выход из привычной среды: движение по болотной местности, физическая нагрузка и работа в команде.\n\nПодробнее:https://t.me/Focus_on_Yelnya"
    else:
